...
import { optiverTestData } from "../data/optiver-test-data"
import { BarChart, Award, Clock } from "lucide-react"

export function OptiverTestSection() {
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-blue-200 dark:border-blue-800">
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <CardTitle className="text-2xl">Optiver Market Making Challenge</CardTitle>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="about" className="mt-0 space-y-4">
          <div className="prose max-w-none dark:prose-invert">
            ...
            <h3>About the Optiver Challenge</h3>
            <p>
              The Optiver Market Making Challenge simulates real-world trading scenarios where you act as a market
        ...
        <TabsContent value="scenarios" className="mt-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {optiverTestData.scenarios.map((scenario, index) => (
        ...
        <TabsContent value="leaderboard" className="mt-0">
          <Card>
            <CardHeader>
              ...
              <CardDescription>See who's leading in the Optiver Market Making Challenge</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="rounded-md border overflow-hidden">
                <Table>
                  ...
                  <TableBody>
                    {optiverTestData.leaderboard.map((entry, index) => (
                      <TableRow key={index}>
        ...
        <TabsContent value="resources" className="mt-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {optiverTestData.resources.map((resource, index) => (
              <Card key={index}>
                <CardHeader className="pb-2">

    ...
    <Accordion type="single" collapsible className="w-full">
            ...
            <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/technicals/trends",
                  }
                )}
                href="/dashboard/technicals/trends"
              >
                <div className="p-1 bg-transparent">
            ...
            <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/technicals/supply-and-demand",
                  }
                )}
                href="/dashboard/technicals/supply-and-demand"
              >
                <div className="p-1 bg-transparent">
            ...
            <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/technicals/patterns",
                  }
                )}
                href="/dashboard/technicals/patterns"
              >
                <div className="p-1 bg-transparent">
          ...
          <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/fundamentals/cftc",
                  }
                )}
                href="/dashboard/fundamentals/cftc"
              >
                <div className="p-1 bg-transparent">
            ...
            <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/fundamentals/market-indicators",
                  }
                )}
                href="/dashboard/fundamentals/market-indicators"
              >
                <div className="p-1 bg-transparent">
            ...
            <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/fundamentals/bank-reports",
                  }
                )}
                href="/dashboard/fundamentals/bank-reports"
              >
                <div className="p-1 bg-transparent">
            ...
            <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/fundamentals/financial-analysis",
                  }
                )}
                href="/dashboard/fundamentals/financial-analysis"
              >
                <div className="p-1 bg-transparent">
          ...
          <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/algorithms/eod-prediction",
                  }
                )}
                href="/dashboard/algorithms/eod-prediction"
              >
                <div className="p-1 bg-transparent">
      ...
      <AccordionItem value="home" className="group flex flex-col">
        ...
        >
          ...
          <span className="hidden lg:block">Improvements</span>
        </AccordionTrigger>
        <AccordionContent className="overflow-hidden transition-all duration-300 max-h-0 group-hover:max-h-screen bg-gray-500/25">
          <ul>
          <li>
              <Link
                className={clsx(
                  ...
                  {
                    "bg-gray-100 text-gray-900 dark:bg-gray-500/25 dark:text-white":
                      pathname === "/dashboard/improvements/journal",
                  }
                )}
                href="/dashboard/improvements/journal"
              >
                <div className="p-1 bg-transparent">

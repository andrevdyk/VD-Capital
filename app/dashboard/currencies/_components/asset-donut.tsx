...
export function AssetDonut() {
  ...
  React.useEffect(() => {
    ...
    if (filteredData.length > 0) {
      ...
      if (latestData) {
        const { asset_mgr_positions_long, asset_mgr_positions_short } = latestData;
        setChartData([
          { pair: "Long Positions", volume: asset_mgr_positions_long, fill: "#03b198" },
          { pair: "Short Positions", volume: asset_mgr_positions_short, fill: "#ff2f67" },
        ]);
      }
    }
